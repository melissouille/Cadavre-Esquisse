...
<div id="formes-modal" style="display: none">
		...
		<div class="templates">
	  		<img id="template1.jpg" class="template" src="../img/templates/template1.jpg"/>
	    	<img id="template2.jpg" class="template" src="../img/templates/template2.jpg"/>
	    	<img id="template3.jpg" class="template" src="../img/templates/template3.jpg"/>
	    	<img id="template4.jpg" class="template" src="../img/templates/template4.jpg"/>
	    	<img id="template5.jpg" class="template" src="../img/templates/template5.jpg"/>
	  </div>
